#ifndef RM_LV2_TRAFFIC_LIGHT_SIMPLE_H
#define RM_LV2_TRAFFIC_LIGHT_SIMPLE_H
...
class rmlv2TrafficLightSimple : public rmBaseModel
{
public:
    rmlv2TrafficLightSimple(
...
#endif // RM_LV2_TRAFFIC_LIGHT_SIMPLE_H
