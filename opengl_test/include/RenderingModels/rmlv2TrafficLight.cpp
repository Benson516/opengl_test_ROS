...
void rmlv2TrafficLight::Init(){
    ...
    image_list.emplace_back(_path_Assets_in, "TFL_red_on.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_red_off.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_yello_on.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_yello_off.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_green_on.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_green_off.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_left_on.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_left_off.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_forward_on.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_forward_off.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_right_on.png", false, true, false);
    // image_list.emplace_back(_path_Assets_in, "TFL_right_off.png", false, true, false);
    image_list.emplace_back(_path_Assets_in, "TFL_counter_background.png", false, true, false);
    ...
    // image_list[ int(IMAGE_ID::LEFT_ON) ].set_enable( light_status[2] == 1 );
    // image_list[ int(IMAGE_ID::LEFT_OFF) ].set_enable( light_status[2] == 0 );
    // image_list[ int(IMAGE_ID::FORWARD_ON) ].set_enable( light_status[2] == 1 );
    // image_list[ int(IMAGE_ID::FORWARD_OFF) ].set_enable( light_status[2] == 0 );
    // image_list[ int(IMAGE_ID::RIGHT_ON) ].set_enable( light_status[2] == 1 );
    // image_list[ int(IMAGE_ID::RIGHT_OFF) ].set_enable( light_status[2] == 0 );
