...
class SCENE_SW6 : public Scene
{
public:
	SCENE_SW6(std::string pkg_path_in);
...
SCENE_SW6::SCENE_SW6(std::string pkg_path_in)
{
    ...
    std::shared_ptr<rmImageBoard> _image_background_2_ptr(new rmImageBoard(_Assets_path, int(MSG_ID::camera_right_rear), false, true, true) );
    ...
    _box2D_ptr.reset(new rmBoundingBox2D(_Assets_path, int(MSG_ID::bounding_box_image_right_rear), false, true ) );
