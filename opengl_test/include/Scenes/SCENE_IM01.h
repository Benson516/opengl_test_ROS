...
class SCENE_IM01 : public Scene
{
public:
	SCENE_IM01(std::string pkg_path_in);
...
SCENE_IM01::SCENE_IM01(std::string pkg_path_in)
{
    ...
    // Bounding box
    // _box2D_ptr.reset(new rmBoundingBox2D(_Assets_path, int(MSG_ID::bounding_box_image_front_top_far), false, false ) );
