...
class SCENE_IM10 : public Scene
{
public:
	SCENE_IM10(std::string pkg_path_in);
...
SCENE_IM10::SCENE_IM10(std::string pkg_path_in)
{
    ...
    // Bounding box
    // _box2D_ptr.reset(new rmBoundingBox2D(_Assets_path, int(MSG_ID::bounding_box_image_left_rear), false, false ) );
