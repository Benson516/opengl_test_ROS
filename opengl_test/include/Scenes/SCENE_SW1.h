...
class SCENE_SW1 : public Scene
{
public:
	SCENE_SW1(std::string pkg_path_in);
...
SCENE_SW1::SCENE_SW1(std::string pkg_path_in)
{
    ...
    std::shared_ptr<rmImageBoard> _image_background_2_ptr(new rmImageBoard(_Assets_path, int(MSG_ID::camera_left_fore), false, true, true) );
    ...
    _box2D_ptr.reset(new rmBoundingBox2D(_Assets_path, int(MSG_ID::bounding_box_image_left_fore), false, true ) );
