...
public:
    ...
    glm::ivec2 GetWindowSize(){   return glm::ivec2(w_width, w_height); }
    ...
    void SetDefaultViewMatrix(glm::mat4 viewMatrix_in);
    void SetDefaultTansformMatrix(glm::mat4 tansformMatrix_in);
...
private:
    ...
    // The following two matrices are legacy
    ...
    // Function pointer for _cal_viewport
    bool (*_cal_viewport)(
        int full_window_width, int full_window_height,
        int &ld_corner_x, int &ld_corner_y, int &viewport_width, int &viewport_height
    );
