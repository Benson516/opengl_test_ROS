...
class SCENE_W5 : public Scene
{
public:
	SCENE_W5(std::string pkg_path_in);
...
SCENE_W5::SCENE_W5(std::string pkg_path_in)
{
    ...
    std::shared_ptr<rmImageBoard> _image_background_2_ptr(new rmImageBoard(_Assets_path, int(MSG_ID::camera_4), false, false, true) );
